  ...
  return (
    <ScrollView 
      ...
      <View style={{alignItems: 'center', width: '100%', maxWidth: 450}}>
        ...
        <Text style={{fontSize: 24, fontWeight: '600', color: '#333', marginBottom: 16, textAlign: 'center'}}>
          API Key Required
        </Text>
        ...
        <View style={{
          ...
          <Text style={{fontSize: 15, fontWeight: '600', color: '#444', marginBottom: 16}}>
            How to get your API key:
          </Text>
          
          <View style={{width: '100%', marginBottom: 16}}>
            <Text style={{fontSize: 14, fontWeight: '600', color: '#555', marginBottom: 10}}>OpenAI</Text>
            <View style={{
              width: '100%', 
              ...
              <Text style={{fontSize: 13, color: '#666', marginBottom: 6}}>• Visit platform.openai.com</Text>
              <Text style={{fontSize: 13, color: '#666'}}>• Create a new secret key</Text>
            </View>
          </View>
          
          <View style={{width: '100%'}}>
            <Text style={{fontSize: 14, fontWeight: '600', color: '#555', marginBottom: 10}}>Anthropic</Text>
            <View style={{
              width: '100%', 
              backgroundColor: 'white', 
              borderRadius: 8, 
              ...
              <Text style={{fontSize: 13, color: '#666', marginBottom: 6}}>• Visit console.anthropic.com</Text>
              <Text style={{fontSize: 13, color: '#666'}}>• Generate a new API key</Text>
            </View>
          </View>
        </View>
      </View>
