...
import { View, Text, TouchableOpacity, FlatList, ColorSchemeName } from 'react-native'
...
const ChatHistoryDrawer: React.FC<ChatHistoryDrawerProps> = ({
  ...
  const { chats, chatsLoading, chatsError, refetchChats } = useChats()
    ...
    >
      <View style={styles.linkItemContent}>
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 4 }}>
          ...
          >
            Tap to continue this conversation
          </Text>
        </View>
      </View>
      <Ionicons 
  ...
  ), [isDark, onChatSelect, formatDate])
